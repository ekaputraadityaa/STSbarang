  ...
  <body>           
                            <form method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mt-4">
                                        <input type="text" class="form-control col-7" placeholder="Masukan Nama Barang"
                                            name="nama_brg">
                                    </div>
                                    <div class="form-group mt-4">
                                        <input type="text" class="form-control col-7" placeholder="Masukan Kategori"
                                            name="kategori">
                                    </div>
                                    <div class="form-group mt-4">
                                        <input type="text" class="form-control col-7" placeholder="Masukan Merk"
                                            name="merk">
                                    </div>
                                    <div class="form-group mt-4">
